...
export function Product9(props){
return<><Box mt={"20px"} ml={"1000px"} style={{display:"flex",flexDirection:"row",flexWrap:"wrap"}}>
<a href="#"><Box>
    <Image w={"80px"} h={"80px"} src={props.last.img}></Image>
</Box>
</a>
...
<Box style={{display:"flex",flexDirection:"column"}}  ml={"-30px"}>
    <a href="#">
<Box ml={"70px"}w={"260px"}>
    <Text color={"#0066cc"} fontSize={"14px"} fontWeight={700}>{props.last.title}</Text>
</Box>
</a>
<Box  ml={"70px"}>
   <ReactStars
...
<Box ml={"70px"} mt={"5px"}>
    <Text color={"black"}>{props.last.price}</Text>
</Box>
</Box>
</Box>
