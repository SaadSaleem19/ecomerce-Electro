...
import { Product1 } from "../../component/Product1/index";
import { Product2 } from "../../component/Product2/index";
import { color } from "framer-motion";
import { AiOutlineUser } from "react-icons/ai";
import { Product3 } from "../../component/Product3/index";
import { Product4 } from "../../component/Product4/index";
import { Product5 } from "../../component/Product5/index";
import { Product6 } from "../../component/Product6/index";
import { Product7 } from "../../component/Product7/index";
import { Product8 } from "../../component/Product8/index";
import { Product9 } from "../../component/Product8/Product9/index";
...
;
  ...
  const addproduct = async () => {
    try {
      const product1 = await apiServices.get("/product");
...
const logout =()=>{
  let userLogout = localStorage.removeItem("userData")
    ...
    >
      <Box style={{ padding: "10px" }}>
        ...
        >
          ...
          >
            ...
            <Menu>
              <MenuButton>
                <dd style={{ fontWeight: 700, fontSize: "14px" }}>About us</dd>
              </MenuButton>
            </Menu>
            ...
            <Menu>
              <MenuButton>
                <dd style={{ fontWeight: 700, fontSize: "14px" }}>
                  Contact us
                </dd>
              </MenuButton>
            </Menu>
      ...
      >
        <Box id="box1" mt={"-180px"} w={"25%"}>
          ...
          >
            END SEASON <br></br>{" "}
            <span style={{ fontWeight: -900 }}>SMART PHONES</span>
          </Text>
          <Text
            color={"#333e48"}
            fontWeight={"bold"}
          ...
          >
            LAST CALL FOR UP TO{" "}
            <span style={{ fontSize: "360%" }}>
              <sup>$</sup>250 <sub style={{ fontSize: "15px" }}>OFF!</sub>
            </span>
          </Text>
          <Box>
            <Button
        ...
        <Box id="box2" mt={"-100px"} ml={"1.3%"}>
          <Image
            src="https://electro.madrasthemes.com/wp-content/uploads/2021/11/slider-v12-image.png"
            w={"180%"}
          ></Image>
        </Box>
      </Box>
      ...
      >
        ...
        >
          {data?.map((value) => {
            return <Product1  val={value} />;
          })}
        </Box>
        <Box>
          <Box marginLeft={"50px"} mt={"3.5%"}>
            <Text style={{ fontSize: "25px" }}>Hot Products Today</Text>
          </Box>
          <Box
            w={"79%"}
            h={"1px"}
          ...
          >
            {prodcut?.map((values) => {
              return <Product2 vel={values} />;
            })}
          </Box>
          <Box marginLeft={"50px"} mt={"3.5%"}>
            <Text style={{ fontSize: "25px" }}>New Products</Text>
          </Box>
          <Box
            w={"79%"}
            h={"1px"}
          ...
          >
            {data3.map((velue) => {
              return <Product3 value={velue} />;
            })}
          </Box>
          <Box marginLeft={"50px"} mt={"3.5%"}>
            <Text style={{ fontSize: "25px" }}>Recommendations</Text>
          </Box>
          <Box
            w={"79%"}
            h={"1px"}
          ...
          >
            {data4.map((velues) => {
              return <Product4 values={velues} />;
            })}
          </Box>
          <Box marginLeft={"50px"} mt={"3.5%"}>
            <Text style={{ fontSize: "25px" }}>Tips & Inspirations</Text>
          </Box>
          <Box
            w={"79%"}
            h={"1px"}
          ...
          >
            {data5.map((vaalue) => {
              return <Product5 velues={vaalue} />;
            })}
          </Box>
          <Box marginLeft={"50px"} mt={"3.5%"}>
            <Text style={{ fontSize: "25px" }}>Known Brands</Text>
          </Box>
          <Box
            w={"79%"}
            h={"1px"}
          ...
          >
            {data6.map((valuee) => {
              return <Product6 veelues={valuee} />;
            })}
          </Box>
        </Box>
      </Box>
      ...
      >
        ...
        >
          <Box id="box7" mt={"200px"} ml={"50px"}>
            ...
            <Box id="star" mt={"50px"}>
              {data7.map((vaaluee) => {
                return <Product7 veeluees={vaaluee} />;
              })}
            </Box>
          </Box>
          <Box id="box8" mt={"249px"} ml={"-30.5%"}>
            ...
            <Box mt={"50px"}>
              {data8.map((veeluees) => {
                return <Product8 seclast={veeluees} />;
              })}
            </Box>
          </Box>
          ...
          <Box id="help" mt={"-200px"} ml={"200px"}>
            ...
            >
              <Box mt={"20px"}>
                <a href="#">
                  {" "}
                  <Text mt={"10px"}>Laptops & computers</Text>
                </a>
                <a href="#">
                  <Text mt={"10px"}>Cameras & Photography</Text>
                </a>
                <a href="#">
                  {" "}
                  <Text mt={"10px"}>Smart Phones & Tablets</Text>
                </a>
                <a href="#">
                  <Text mt={"10px"}>Video Games & Consoles</Text>
                </a>
                <a href="#">
                  {" "}
                  <Text mt={"10px"}>TV & Audio</Text>
                </a>
                <a href="#">
                  <Text mt={"10px"}>Gadgets</Text>
                </a>
                <a href="#">
                  <Text mt={"10px"}>Waterproof Headphones</Text>
                </a>
              </Box>
              <Box mt={"20px"} ml={"80px"}>
                <a href="#">
                ...
                <a href="#">
                  <Text mt={"10px"}>Contact</Text>
                </a>
                <a href="#">
                  <Text mt={"10px"}>Wishlist</Text>
                </a>
                <a href="#">
                  <Text mt={"10px"}>Compare</Text>
                </a>
                <a href="#">
                  {" "}
                  <Text mt={"10px"}>FAQ</Text>
                </a>
                <a href="#">
                  {" "}
                  <Text mt={"10px"}>Social Directory</Text>
                </a>
              </Box>
              <Box mt={"20px"} ml={"140px"}>
                <a href="#">
                  {" "}
                  <Text mt={"10px"}>My Account</Text>
                </a>
                <a href="#">
                  {" "}
                  <Text mt={"10px"}>Trackk your Order</Text>
                </a>
                <a href="#">
                  {" "}
                  <Text mt={"10px"}>Customer Service</Text>
                </a>
                <a href="#">
                  {" "}
                  <Text mt={"10px"}>Return/Exchange</Text>
                </a>
                <a href="#">
                  <Text mt={"10px"}>FAQs</Text>
                </a>
                <a href="#">
                  <Text mt={"10px"}>Product Spport</Text>
                </a>
              </Box>
            </Box>
          </Box>
